...
//   jobApplicationDeadline: { type: Date, required: true }, // Changed to Date type
//   title: { type: String, trim: true, required: true },
//   type: {
//     type: String,
//     enum: ["Full Time", "Part Time", "Remote"], // Changed to Full Time to match frontend
//     required: true,
//   },
//   // category: {
...
//   // },
//   vacancies: { type: Number, required: true }, // Changed to Number type
...
//     required: true,
//   },
//   minimumJobSalary: { type: Number, required: true }, // Changed to Number type
//   maximumJobSalary: { type: Number, required: true }, // Changed to Number type
...
//     state: { type: String, default: "active" }, // or any other default value
